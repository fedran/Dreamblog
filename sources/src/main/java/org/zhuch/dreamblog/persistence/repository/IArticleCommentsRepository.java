...
public interface IArticleCommentsRepository extends Repository<ArticleCommentsRow, Long> {
    ...
    @Query(
        value = "SELECT a.article_id as article_id, a.user_id as user_id, " +
            "a.caption as caption, a.content as content, a.created as created, " +
            "a.updated as updated, a.likes as likes, a.dislikes as dislikes, " +
             "a.views as views, comment_id, c.content as content_comment, " +
